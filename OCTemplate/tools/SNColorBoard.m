...
- (void)redTextFieldEditingChanged:(UITextField *)sender {
...
- (void)greenTextFieldEditingChanged:(UITextField *)sender {
  NSString    *string    = sender.text;
  NSString    *regex     = @"(0\\.\\d+)|(1\\.\\d+)|(\\d+)|(\\d+\\.\\d+)";
  NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regex];
  if (![predicate evaluateWithObject:string]) { return; }
...
- (void)blueTextFieldEditingChanged:(UITextField *)sender {
  NSString    *string    = sender.text;
  NSString    *regex     = @"(0\\.\\d+)|(1\\.\\d+)|(\\d+)|(\\d+\\.\\d+)";
  NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regex];
  if (![predicate evaluateWithObject:string]) { return; }
...
- (void)alphaTextFieldEditingChanged:(UITextField *)sender {
  NSString    *string    = sender.text;
  NSString    *regex     = @"(0\\.\\d+)|(1\\.\\d+)|(\\d+)|(\\d+\\.\\d+)";
  NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regex];
  if (![predicate evaluateWithObject:string]) { return; }
