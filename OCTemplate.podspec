#
#  Be sure to run `pod spec lint OCTemplate.podspec' to ensure this is a
...
spec.version = "0.0.4"
  ...
  spec.description  = "OCTemplate git test"

  spec.homepage     = "http://EXAMPLE/OCTemplate"
  ...
  spec.source       = { :git => "https://github.com/stone0117/OCTemplate.git", :tag => "#{spec.version}" }
  ...
  # RAC
  spec.dependency 'ReactiveObjC', '~> 3.0.0'
