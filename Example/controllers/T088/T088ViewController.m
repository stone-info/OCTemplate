...
#pragma ide diagnostic ignored "err_objc_property_requires_object"
#pragma ide diagnostic ignored "CannotResolve"
#import "Valet-Swift.h"
...
- (void)viewDidLoad {
  ...
  // self.myValet = [VALValet valetWithSharedAccessGroupIdentifier:@"com.stone.common" accessibility:VALAccessibilityWhenPasscodeSetThisDeviceOnly];
  self.myValet =   [VALValet valetWithIdentifier:@"com.stone.common" accessibility:VALAccessibilityWhenUnlocked];
}
